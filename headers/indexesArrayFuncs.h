...
LastNamePair* createLastNameIndexesArray(StationReport array[], int size); // Вовзращает указатель на индекс-массив с фамилиями
ThreatsEliminatedPair* createThreatesElimIndexesArray(StationReport array[], int size); // Вовзращает указатель на индекс-массив с количеством устраненных угроз
